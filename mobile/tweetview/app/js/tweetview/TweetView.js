define(["dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "dojo/aspect", "dojo/i18n", "dojo/dom-class", "dojo/dom-attr", "dojox/mobile/ScrollableView", "dojox/mobile/ListItem", "dojo/DeferredList", "dojo/io/script", "tweetview/_ViewMixin", "dijit/registry", "dojo/i18n!dojo/cldr/nls/gregorian"], function(declare, arrayUtil, lang, aspect, i18n, domClass, domAttr, ScrollableView, ListItem, DeferredList, ioScript, _ViewMixin, registry) {
	...
	return declare("tweetview.TweetView", [ScrollableView, _ViewMixin], {
		...
		startup: function() {
			...
			setInterval(lang.hitch(this, function() {
				arrayUtil.forEach(this.getElements("tweetviewTime", this.domNode), function(timeNode) {
		...
		onTweetsReceived: function(rawTweetData) {
			...
			refreshButton.set("selected", false);
